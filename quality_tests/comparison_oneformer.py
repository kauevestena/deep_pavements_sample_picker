...
for territory in tqdm(territory_list):
    ...
    for sample_number in tqdm(os.listdir(territory_folderpath)):
        ...
        # save the image
        outpath = os.path.join(sample_folderpath,extra_str + '_result'+EXT)
        outpath_blended = os.path.join(sample_folderpath, sample_number+ extra_str+'_result_blended'+EXT)
